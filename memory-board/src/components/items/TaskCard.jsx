...
export default function TaskCard({ item }) {
  const { id, title = 'Tasks', tasks = [], position, rotation, pinColor, width = 2.0, height = 2.2 } = item;
  ...
  return (
    ...
    >
      ...
      <RoundedBox args={[width, height, 0.05]} radius={0.04} smoothness={4} castShadow receiveShadow>
        <meshStandardMaterial color="#fafaf8" roughness={0.85} metalness={0} />
      </RoundedBox>
